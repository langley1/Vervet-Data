...
HighHum_Fe_6though10<- with(HighHum_Fe_DF, HighHum_Fe_DF[hour(Scan.time) >= 6 & hour(Scan.time) < 10,]) #Now specifying which time chunk I'd like to look at
HighHum_Fe_6though10
```
